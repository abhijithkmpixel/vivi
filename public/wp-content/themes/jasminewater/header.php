...
<div id="page" class="site" data-scroll-container>
  ...
  var site_url = '<?php echo (ICL_LANGUAGE_CODE == 'ar') ? site_url()  .'\\/ar' : site_url() .'\\/en' ; ?>';
  ...
  var sar = "<?php esc_html_e( 'SAR', 'jasminewater' ); ?>";
  </script>
      ...
      <div class="container">
        ...
        <nav id="site-navigation" class="main-navigation">
          ...
          <div class="cart dynamic-cart">
            ...
            <a href="<?php echo (ICL_LANGUAGE_CODE == 'ar') ? site_url()  .'\\/ar' : site_url() .'\\/en' ; ?>/cart" class="icon-wrap">
