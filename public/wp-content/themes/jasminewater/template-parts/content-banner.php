...
<section class="banner inner-banner" data-scroll-section>
  <div class="page-banner-wrapper">
    <div class="swiper-container banner-inner-slider" <?php echo (ICL_LANGUAGE_CODE == 'ar') ? 'dir="rtl"' : '' ; ?>>
      ...
      <?php while( have_rows('banner_slider', $page_id) ): the_row(); 
        ...
        <div class="swiper-slide slide-item <?php echo($side_image) ? 'with-side-image':''; ?>">
          ...
          <?php if($side_image): jasminewater_picture($side_image, 'bottle-lg', 'swiper-bottle-img', 'bottle-lg'); endif; ?>
        </div>
      <?php endwhile; ?>
      </div>
    </div>
