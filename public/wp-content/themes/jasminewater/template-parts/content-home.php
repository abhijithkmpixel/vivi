...
<section class="banner home" data-scroll-section>
  <div class="swiper-container banner-slider" <?php echo (ICL_LANGUAGE_CODE == 'ar') ? 'dir="rtl"' : '' ; ?>>
          ...
          <div class="col wow">
            <div class="shop aos-init" data-scroll data-scroll-class="aos-animate" data-aos="fade-up" data-aos-delay="100">
              ...
              <?php else: ?>
                ...
                <?php else: ?>
                <a href="<?php echo site_url(); ?>/en/products" class="btn btn-primary"><?php echo $link['title']; ?></a>
                <?php endif; ?>
              <?php endif; ?>
            </div>
          </div>
