...
<div class="sub-title">
  <div class="title wide">
    ...
    <p><?php esc_html_e( 'Dear', 'jasminewater' ); ?> <strong><?php echo $current_user->first_name; ?></strong> <?php esc_html_e( 'You can view your registered personal data and you can update your profile as well.', 'jasminewater' ); ?> (<?php esc_html_e( 'not', 'jasminewater' ); ?> <strong><?php echo $current_user->first_name; ?>?</strong> <a href="<?php echo wc_logout_url(); ?>"><?php esc_html_e( 'Log out', 'jasminewater' ); ?></a>)</p>
  </div>
</div>
  ...
  <div class="flex profile-cols woocommerce">
    <div class="col info">
      <div class="shop-table-wrap no-border">
        <table class="woocommerce-table shop_table profile-details">
          ...
          <tr>
            <td><?php esc_html_e( 'Phone', 'jasminewater' ); ?>:</td> <td><strong style="direction: ltr; display: inline-block;"> <?php echo $user_phone; ?> </strong></td>
          </tr>
          <tr>
            <td><?php esc_html_e( 'Mobile', 'jasminewater' ); ?>:</td> <td><strong style="direction: ltr; display: inline-block;"> <?php echo $user_mobile; ?> </strong></td>
          </tr>
        </table>
        <div class="btn-wrap">
          <a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-account' ) ); ?>" class="btn btn-default btn-small">
			  <?php the_field('update_profile_label','option'); ?>
		  </a>
          <a href="<?php echo esc_url( wc_get_endpoint_url( 'orders' ) ); ?>" class="btn btn-primary btn-small">
			  <?php the_field('view_order_label','option'); ?>
		  </a>
        </div>
      </div>
    </div>
    <div class="col address">
      <?php if($billing_address): ?>
        ...
        <a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-address', 'billing' ) ); ?>" class="btn btn-default-outline btn-small"><?php the_field('update_address_label','option'); ?></a>
      <?php endif; ?>
    </div>
  </div>
</div>
