  ...
  <div class="flex col2-set">
    <div class="col">
      ...
      <p class="woocommerce-form-row form-row desktop">
        <a href="<?php echo (ICL_LANGUAGE_CODE == 'ar') ? site_url()  .'\\/ar' : site_url() .'\\/en' ; ?>/login" class="btn btn-link"><?php esc_html_e( 'Already have an account with Vivi.', 'jasminewater' ); ?>  &nbsp; <strong><?php esc_html_e( 'Login Now', 'jasminewater' ); ?> <i class="icon-next"> </i></strong></a>
      </p>
    </div>
    <div class="col">
...
<!--       <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
        <label for="user_phone"><?php //esc_html_e( 'Phone', 'woocommerce' ); ?>&nbsp;</label>
...
<div style="display: none;" id="otp-register-form">
  ...
  <form id="form_mobile" name="otp-register" class="form-login">
    <p class="form-row">
      ...
      <input type="email" class="input-text" placeholder="<?php esc_html_e( 'Enter email address', 'jasminewater' ); ?>" id="email_address" name="email_address">
    </p>
    <p class="form-row">
